...
function relatedPostsHtml(relacionados, tagEsc) {
...
function renderPage({ post, siteOrigin, requestUrl, relacionados = [], tagSlug = "" }) {
...
export async function onRequestGet(context) {
  ...
  const html = renderPage({ post, siteOrigin, requestUrl, relacionados, tagSlug });
