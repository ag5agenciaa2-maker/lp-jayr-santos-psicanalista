...
<body data-ssr="true" data-slug="${escapeHtml(post.slug)}">
  ...
  <div class="wrap" style="max-width: 760px; margin-bottom: 40px; padding: 0 var(--pad-x);">
    <div class="article-cta">
      ...
      <a href="https://wa.me/5521991028333?text=Ol%C3%A1%2C%20li%20o%20seu%20artigo%20e%20gostaria%20de%20agendar%20uma%20conversa." class="btn btn--solid btn--lg js-wa" data-wa-text="Olá, li o seu artigo e gostaria de agendar uma conversa." target="_blank" rel="noopener noreferrer">Agendar Sessão via WhatsApp</a>
    </div>
  </div>
    ...
    <section class="article-comments" aria-label="Comentários do artigo">
      ...
      <form id="comment-form" class="article-comments__form" novalidate>
        <div class="field">
          ...
          <input type="text" id="c-nome" name="nome" required maxlength="100" placeholder="Como você se chama?" />
        </div>
        <div class="field">
          <label for="c-texto">Seu comentário</label>
          <textarea id="c-texto" name="texto" rows="3" required maxlength="2000" placeholder="Compartilhe sua reflexão sobre o artigo..."></textarea>
        </div>
    ...
    <div class="wrap footer__grid">
      ...
      <div class="footer-contact">
        ...
        <ul>
          ...
          <li>
            <a href="https://wa.me/5521991028333" target="_blank" rel="noopener noreferrer" class="js-wa" data-wa-text="Olá, vim através do site e gostaria de agendar uma conversa.">
              ...
              <span>WhatsApp · (21) 99102-8333</span>
            </a>
          </li>
        </ul>
      </div>
  ...
  <div class="wa-premium-container">
    ...
    <a href="https://wa.me/5521991028333?text=Ol%C3%A1%2C%20vim%20atrav%C3%A9s%20do%20site%20e%20gostaria%20de%20agendar%20uma%20conversa." class="wa-float-btn js-wa" data-wa-text="Olá, vim através do site e gostaria de agendar uma conversa." target="_blank" rel="noopener noreferrer" id="wa-main-btn" aria-label="Fale conosco pelo WhatsApp">
