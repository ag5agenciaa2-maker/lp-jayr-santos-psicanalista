...
<body>
  ...
  <section class="section" style="background: var(--noturno); color: var(--offwhite); text-align: center; padding: 60px 20px;">
    <div class="wrap" style="max-width: 700px;">
      ...
      <a href="https://wa.me/5521991028333?text=Ol%C3%A1%2C%20li%20o%20seu%20blog%20e%20gostaria%20de%20agendar%20uma%20conversa." class="btn btn--solid btn--lg js-wa" data-wa-text="Olá, li o seu blog e gostaria de agendar uma conversa." target="_blank" rel="noopener noreferrer">Falar pelo WhatsApp</a>
    </div>
  </section>
